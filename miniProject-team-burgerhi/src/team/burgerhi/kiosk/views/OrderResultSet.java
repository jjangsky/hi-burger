...
public class OrderResultSet {
	...
	public void displayDmlResult(String code) {
		switch(code) {
			case "updateUserInfoSuccess" : System.out.println("입력하신 회원 정보 수정이 모두 완료 되었습니다!"); break;
			case "updateUserInfoFail" : System.out.println("죄송합니다. KIOSK 오류로 인해 회원 정보 수정이 완료되지 않았습니다.");
			case "deleteUserInfoSuccess" : System.out.println("고객님의 회원 탈퇴가 정상적으로 진행 되었습니다. 이용해 주셔서 감사합니다."); break;
